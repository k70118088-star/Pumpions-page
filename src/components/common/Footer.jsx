...
const Footer = () => {
  return (
    <div className="w-full bg-[url('/assets/webp/footer-bg.webp')] h-83.75 bg-center bg-cover bg-no-repeat">
            <div className='max-w-285 w-full mx-auto mt-22.5 flex flex-col items-center justify-center'>
                ...
                <p className='max-w-49.5 sm:max-w-106.25 text-white/70 text-[8px] sm:text-[12px] leading-[202%] font-normal text-center'>Suspendisse vestibulum a tellus sit amet mattis</p>
